...
public class BytecodeMethod {
  ...
  public MethodPolicy policy() {return _policy;}
  public Typing get_type (int label) {return _typingMap.get(label);}
  public int get_objectLevel () {return _objectLevel;}
  
  public int ins_count () {return _labels.length;}
