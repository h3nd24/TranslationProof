...
public class CertContainer {
  static class MethodKey implements Comparable<MethodKey>{
	...
	public MethodKey (String class_name, String name, String desc) {_class_name=class_name; _name=name; _desc=desc;}
  ...
  public CertContainer() {_methods = new TreeMap<MethodKey, MethodCert>();}
  
  public void set_lvl_pool(LevelPool lvl_pool) {_lvl_pool = lvl_pool;}
  public LevelPool lvl_pool() {return _lvl_pool;}
  
  public void set_lvl_rel(LevelRelationship lvl_rel) {_lvl_rel = lvl_rel;}
  public LevelRelationship lvl_rel() {return _lvl_rel;}
  
  public void set_default_level_id (int default_level_id) {_default_level_id = default_level_id;}
  public int default_level_id() {return _default_level_id;}
  
  public void set_field_policy (FieldPolicy ft) {_ft = ft;}
  public FieldPolicy ft() {return _ft;}
