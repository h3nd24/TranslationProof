...
public class Typing {
	...
	public Typing(BasicLevel se) { this (se, new RT(), null, false);}
	public Typing() { this (BasicLevel.bot);}

	public void add_rt (Integer key, ExtendedLevel value) {_rt.put(key, value);}
	public ExtendedLevel get_rt_at (Integer key) {return _rt.get(key);}
	public void update_res (ExtendedLevel res) {_res = res;}
	public ExtendedLevel get_res () {return _res;}
	public boolean exists_res() {return (_res != null);}
	public void update_flag(boolean flag) {_flag = flag;}
	public boolean get_flag() {return _flag;}
	public RT get_rt () {return _rt;}
	public void update_se (BasicLevel se) {_se = se;}
	public BasicLevel get_se () {return _se;}
