...
public class MethodPolicy {
  ...
  public MethodPolicy() {};
  public int localVariable_size() {return _n_ka;}
  public ExtendedLevel ka_at(int localVar) {return _ka[localVar];}
  public int returnType_size() {return _n_kr;}
  // 0 for the security level of a normal return
  public ExtendedLevel kr_at (int retType) {return _kr[retType];}
  public BasicLevel kh() {return _kh;}
