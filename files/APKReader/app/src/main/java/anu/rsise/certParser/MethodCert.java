...
public class MethodCert {
  ...
  public Integer[] get_region (int label) {return _region.get(label);}
  public Integer get_junction (int label) {return _junction.get(label);}
  public void set_class_name(String class_name) {_class_name=class_name;}
  public String class_name() {return _class_name;}
  public void set_name(String name) {_name=name;}
  public String name () {return _name;}
  public void set_desc(String desc) {_desc=desc;}
  public String desc () {return _desc;}
  public BytecodeMethod get_bytecodeMethod(int objectLevel) {return _bm_map.get(objectLevel);}
  ...
  public static MethodCert read(InputStream isr, LevelPool lvl_pool)
  {
	...
	try
	{
	  ...
	  for (int i = 0; i < length; i++)
	  {
	    ...
	    if (jun <= 0) {result._junction.put((int)label, null);}
	    else {result._junction.put((int)label, (int)jun);}
	  }
