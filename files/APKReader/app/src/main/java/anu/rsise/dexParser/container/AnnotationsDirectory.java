	...
	public static class AnnotationSetItem
	{
		public static class AnnotationItem
		{
			...
			public String toString()
			{
				...
				switch(visibility)
				{
					case (VISIBILITY_BUILD) : sb.append("VISIBILITY_BUILD"); break;
					case (VISIBILITY_RUNTIME) : sb.append("VISIBILITY_RUNTIME"); break;
					case (VISIBILITY_SYSTEM) : sb.append("VISIBILITY_SYSTEM"); break;
				}
				sb.append("\">");
