...
public class MethodContainer {
	...
	public static class MethodItem
	{
		...
		public String toString()
		{
			...
			if (methodAnnotationExists) sb.append(" method annotation : " + methodAnnotation.toString());
			if (parameterAnnotationExists) sb.append(" parameter annotation : " + parameterAnnotation.toString());
			return sb.toString();
		}
		
		public void setMethodAnnotation(AnnotationsDirectory.AnnotationSetItem annotation) {methodAnnotationExists = true; this.methodAnnotation = annotation; }
		public void setParameterAnnotation(AnnotationsDirectory.AnnotationSetRefList annotation) {parameterAnnotationExists = true; this.parameterAnnotation = annotation; }
		
		public boolean hasMethodAnnotation() {return methodAnnotationExists;}
		public boolean hasParameterAnnotation(){return parameterAnnotationExists;}
	}
