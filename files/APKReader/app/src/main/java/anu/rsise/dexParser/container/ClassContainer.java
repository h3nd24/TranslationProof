...
public class ClassContainer {
	...
	public static class ClassItem
	{
		...
		public void setClassAnnotation(AnnotationsDirectory.AnnotationSetItem annotation) {hasAnnotation = true; this.classAnnotation = annotation;}
	}
	...
	public String toString()
	{
		...
		for (int i = 0; i < size; i++)
		{
			...
			sb.append("\n");
			if (items[i].hasAnnotation) sb.append("\t Annotation \t: " + items[i].classAnnotation.toString() + "\n");
			...
			for (int j = 0; j < items[i].class_data.static_fields_size; j++)
			{
				...
				if (ef[j].field.hasAnnotation()) sb.append("\t\t\t" + ef[j].field.annotation.toString() + "\n");
	...
	private String methodString(EncodedMethod[] em, int size)
	{
		...
		for (int j = 0; j < size; j++)
		{
			...
			if (em[j].method.hasMethodAnnotation()) sb.append("\t\t\t Meth Annot\t: " + em[j].method.methodAnnotation + "\n");
			if (em[j].method.hasParameterAnnotation()) sb.append("\t\t\t Param Annot\t: " + em[j].method.parameterAnnotation + "\n");
